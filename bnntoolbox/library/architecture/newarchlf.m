...
for k = 1:layer_num
    ...
    if (k == 1)&(layer_num >= 2)
        ...
        col_index   = [1:layer_neuron_num , layer_neuron_num + neuron_num(k + 1) + 1:total_neuron_num];
    ...
    elseif (layer_num >= 2)
        ...
        if (k == layer_num)
            col_index   = [1:total_pre_layer_neuron_num - pre_layer_neuron_num , ...
                total_pre_layer_neuron_num + 1:total_pre_layer_neuron_num + layer_neuron_num , ...
                total_pre_layer_neuron_num + layer_neuron_num + 1:total_neuron_num];
        else
            post_layer_neuron_num   = neuron_num(k + 1);
            
            col_index   = [1:total_pre_layer_neuron_num - pre_layer_neuron_num , ...
                total_pre_layer_neuron_num + 1:total_pre_layer_neuron_num + layer_neuron_num , ...
                total_pre_layer_neuron_num + layer_neuron_num + post_layer_neuron_num + 1:total_neuron_num];
        end

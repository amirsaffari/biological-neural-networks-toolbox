function [value , isterminal , direction] = iz_threshold_fun(t , y)
% IZ_THRESHOLD_FUN     Threshold function for Izhikevich model
% 
%   Version:    1.0
%   ----------------------------------
...
if ischar(net.Neurons.SpikeDet.SpikeDetFunParam)
    switch lower(net.Neurons.SpikeDet.SpikeDetFunParam)
        case 'def'
            threshold   = 30*ones(net.Architecture.NeuronNum , 1);
        otherwise

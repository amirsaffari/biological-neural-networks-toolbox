function NeuronModel = newneuronml(model_param , spike_det_fun_param)
% NEWNEURONML   Create Morris-Lecar model for Biological Neural
%               Network (BNN)
% 
%   Version:    1.0
%   ----------------------------------
...
neuron_fun      = 'morris_lecar';
model_type      = 'CDE';
state_num       = 2;
spike_det_fun   = 'ml_threshold_fun';
reset_fun       = 'none';
reset_fun_param = 'def';
